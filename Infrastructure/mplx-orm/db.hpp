...
namespace mplx::orm {
  ...
  public:
    ...
    void bind_int64(int idx, long long v) {
    ...
    long long column_int64(int i) const {
      return sqlite3_column_int64(stmt_, i);
    }
    std::string column_text_str(int i) const {
      auto p = reinterpret_cast<const char *>(sqlite3_column_text(stmt_, i));
